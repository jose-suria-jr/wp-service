...
function jsoncontentimporterGutenbergBlock() {
	...
	function jci_free_render( $attributes, $content ) {
		...
		<br>You may also open the lower right "<b>JCI Advanced</b>"-section. Insert at "One of these words must be displayed:" the word "two". And at "JSON-depth of the above displayed Words:" the number 3. Do you see the difference at once?
		<hr>';
		} 
